...
<div class="pull-left"> 
    <h4>
        <span style="color: white;padding: 5px;">Depression ปีงบประมาณ 2559</span>
    </h4>  
    <a class="btn  btn-success"
       href="<?= Url::to(['indexdepress']) ?>">
    ...
    [
        ...
        echo GridView::widget([
            ...
            'panel' => [
                ...
                //'heading' => 'Depression ปีงบประมาณ 2559'            
            ],
        ]);
        ?>
        <?php Pjax::end(); ?> 