...
$this->title = 'DM คัดกรองเบาหวาน อายุ >=35 ปี';
...
$js_datas = implode(',', $datas);
    ...
    $this->registerJs("
        ...
        $('#graph').highcharts({
            ...
            title: {
                text: 'เปอร์เซ็นต์ คัดกรองเบาหวาน อายุ >= 35 ปี'
            },
            subtitle: {
...
<div class="pull-left">
    <h4>
        <span style="color: white;padding: 5px">DM คัดกรองเบาหวาน อายุ >= 35 ปี ปีงบประมาณ 2559</span>
    </h4>
    <a class="btn  btn-primary"
       href="<?= Url::to(['indexscreendm']) ?>">
    ...
    [
        ...
        echo GridView::widget([
            ...
            'panel' => [
                ...
                //'heading' => 'DM คัดกรองDM อายุ>=35ปี ปีงบประมาณ 2559'
            ],
        ]);
        ?>
        <?php Pjax::end(); ?> 