...
echo GridView::widget([
    ...
    'panel' => [
        ...
        'heading' => 'DM รายชื่ออัตราการใช้บริการของผู้ป่วยใน ด้วยโรคเบาหวานที่มีภาวะแทรกซ้อนระยะสั้น 
สิทธิ UC ของผู้ป่วยเบาหวานที่ลงทะเบียนสิทธิหน่วยบริการประจำ (กองทุน)
',
    ],
]);
?>
