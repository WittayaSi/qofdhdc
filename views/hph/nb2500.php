...
$js_datas = implode(',', $datas);
    ...
    $this->registerJs("
        ...
        $('#graph').highcharts({
            ...
            title: {
                text: 'เปอร์เซ็นต์ น้ำหนักเด็กแรกเกิดน้อยกว่า 2500 กรัม'
            },
            subtitle: {
...
<div class="pull-left">  
    <h4>
        <span style="color: white;padding: 5px;">NB น้ำหนักเด็กแรกเกิดน้อยกว่า 2500 กรัม ปีงบประมาณ 2559</span>
    </h4> 
    <a class="btn  btn-success"
       href="<?= Url::to(['indexnb2500']) ?>">
    ...
    [
        ...
        echo GridView::widget([
            ...
            'panel' => [
                ...
                //'heading' => 'NB น้ำหนักเด็กแรกเกิดน้อยกว่า2500กรัม ปีงบประมาณ 2559'            
            ],
        ]);
        ?>
        <?php Pjax::end(); ?> 